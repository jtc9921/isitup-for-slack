...
if($token != 'LXIxQw6h67snU9Fe4mh46Ss0'){ #replace this with the token from your slash command configuration page
...
$user_agent = "IsitupForSlack/1.0 (https://github.com/jtc9921/istiupforslack; jeremiah@casamarco.com)";
